...
btn_equals = tk.Button(root, text='=', command=lambda: evaluate_calculation(), width=11, font='Arial')
btn_equals.grid(row=6, column=3, columnspan=2)
btn_clear = tk.Button(root, text='C', command=lambda: clear_field(), width=11, font='Arial')
